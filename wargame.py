...
while great_war.showStatus() == "Vikings and Saxons are still in the thick of battle.":
    ...
    # wargame show me an error when the program try to call a saxon and were no left in the list, i did not change it because was no part of the instruction of the project.